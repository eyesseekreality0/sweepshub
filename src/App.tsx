...
function App() {
  ...
  return (
    <div className="min-h-screen bg-midnight-975 text-white">
      <header className="sticky top-0 z-20 bg-midnight-975/90 backdrop-blur border-b border-electric-500/10">
        <div className="container mx-auto px-4 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <h1 className="text-xl font-heading font-bold text-neon-500">Choose your page</h1>
          </div>
