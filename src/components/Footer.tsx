...
const Footer = () => {
  return (
    <footer className="bg-charcoal-900 pt-4 md:pt-16 pb-4 md:pb-8 border-t border-electric-500/20" id="contact">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mb-4 md:mb-12">
          ...
          >
            <div className="flex items-center space-x-2 md:space-x-3 mb-3 md:mb-4">
              <div className="h-10 w-10 md:h-10 md:w-10 rounded-full bg-gradient-to-br from-electric-500 to-neon-500 flex items-center justify-center font-heading text-black font-bold shadow-[0_0_18px_rgba(57,255,20,0.45)]">
                PG
              </div>
            ...
            <p className="text-white/70 mb-4 md:mb-6 text-sm md:text-base">
              Neon-soaked gaming drops, backend portals, and a crew that keeps the glow going all night.
            </p>
          </motion.div>
          ...
          >
            <h3 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-neon-500">Contact Us</h3>
            <ul className="space-y-2 md:space-y-4">
              <li>
                <a
                  href="mailto:support@sweepshub.us"
                  className="flex items-center gap-2 text-white/70 hover:text-neon-500 transition-colors duration-200 text-sm md:text-base"
                >
